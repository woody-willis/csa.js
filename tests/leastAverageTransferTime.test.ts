...
function createCSAInstance(
    priority: Priority = Priority.LeastAverageTransferTime
): CSA {
...
describe('Least Average Transfer Time', () => {
    test('should create an Least Average Transfer Time CSA instance', () => {
        ...
        expect(csa.instance).toBeInstanceOf(CSALeastAverageTransferTime);
    });

    test('should produce the correct least average transfer time with no changes', async () => {
        const csa = createCSAInstance();
    ...
    test('should produce the correct least average transfer time with 1 change', async () => {
        const csa = createCSAInstance();
