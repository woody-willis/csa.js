...
function createCSAInstance(priority: Priority = Priority.EarliestArrival): CSA {
...
describe('Earliest Arrival', () => {
    test('should create an Earliest Arrival CSA instance', () => {
        ...
        expect(csa.instance).toBeInstanceOf(CSAEarliestArrival);
    });

    test('should produce the correct earliest arrival time with no changes', async () => {
        const csa = createCSAInstance();
    ...
    test('should produce the correct earliest arrival time with 1 change', async () => {
        const csa = createCSAInstance();
    ...
    test('should produce the correct earliest arrival time with 2 changes', async () => {
        const csa = createCSAInstance();
